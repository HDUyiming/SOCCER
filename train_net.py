...
from maskrcnn_benchmark.engine.trainer import do_train, do_da_train, do_soccer_da_train
...
from maskrcnn_benchmark.modeling.stochastic_complementary_masking import Stochastic_Complementary_Masking
import warnings
...
def train(cfg, local_rank, distributed):
    ...
    if cfg.MODEL.DOMAIN_ADAPTATION_ON:
        ...
        if cfg.MODEL.SOCCER_ON:
        # SOCCER❗
            if cfg.MODEL.SCM_AUGMENTATION:
            ...
            SCM = Stochastic_Complementary_Masking(
...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="configs/Faster_rcnn_R_50_FPN_SOCCER_C2F.yaml",
        metavar="FILE",
