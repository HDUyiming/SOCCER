...
To mitigate the problem, we propose a s<font color=red>我是红色</font>tochastic context consistency reasoning (SOCCER) network with the self-training framework. 
