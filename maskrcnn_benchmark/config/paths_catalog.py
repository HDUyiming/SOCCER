...
class DatasetCatalog(object):
    DATA_DIR = "/home/cuiyiming/datasets"
    DATASETS = {
        "voc_2012_train_cocostyle": {
            "img_dir": "VOCdevkit/VOC2012/JPEGImages",
            "ann_file": "VOCdevkit/VOC2012.json"
        },
        "voc_2007_2012_train_cocostyle": {
            "img_dir": "VOC_2007_2012/images",
            "ann_file": "VOC_2007_2012/voc_2007_2012.json"
        },
        ...
        'sim10k_cocostyle': {
                "img_dir": 'sim10k/JPEGImages/train',
                "ann_file": 'sim10k/car_instances.json'
        },
        'kitti_cocostyle': {
                "img_dir": "KITTI/training/image_2",
                "ann_file": "KITTI/caronly_training.json"
        },
        ...
        'cityscapes_7class_train_cocostyle':{
                "img_dir": 'cityscapes/leftImg8bit',
                "ann_file": "cityscapes/annotations/7class_filtered_gtFine_train_poly.json",
        },
        'cityscapes_7class_val_cocostyle':{
            "img_dir": 'cityscapes/leftImg8bit',
            "ann_file": "cityscapes/annotations/7calss_filtered_gtFine_val_poly.json",
        },
        'bdd100k_train_cocostyle':{
            "img_dir": "bdd100k/images/100k/train",
            "ann_file": "bdd100k/bdd100k_labels_daytime_det_coco_train.json",
        },
        'bdd100k_val_cocostyle':{
            "img_dir": "bdd100k/images/100k/val",
            "ann_file": "bdd100k/bdd100k_labels_daytime_det_coco_val.json",
        },
        'clipart_train_cocostyle': {
                "img_dir": 'clipart1k/clipart/JPEGImages',
                "ann_file": 'clipart1k/clipart1k_train.json',
        },
        'clipart_val_cocostyle': {
                "img_dir": 'clipart1k/clipart/JPEGImages',
                "ann_file": 'clipart1k/clipart1k_test.json',
        },
    }
